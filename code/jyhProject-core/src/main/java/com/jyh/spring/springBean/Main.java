...
public class Main {
    public static void main(String[] args){
        ...
        ApplicationContext ac = new FileSystemXmlApplicationContext("F:/study/jyhProject/code/jyhProject-core/src/main/resources/com/jyh/spring/springBean/bean.xml");
